...
ltn::GraphicsPipeline::GraphicsPipeline(CoreInstance& _core, SwapChain& swapchain) : m_core_instance{ _core }, m_swapchain{ swapchain }
{
...
void ltn::GraphicsPipeline::load_shaders()
{
	auto vertShaderCode = readFile("./assets/shaders/simple_shader.vert.spv");
...
*/
void ltn::GraphicsPipeline::create_pipleine(
	...
	std::vector<VkDescriptorSetLayout>* descriptors)
{
	...
	*/
	...
	multisampling.rasterizationSamples = m_core_instance.numSamples();
...
VkShaderModule ltn::GraphicsPipeline::createShaderModule(const std::vector<char>& code)
{
